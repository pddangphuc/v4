...
class Slider extends \Cms\Classes\ComponentBase
{
    ...
    public function slides()
    {
        ...
        if (!empty($landing)) {
            ...
            $slideSelect = Landing::where('slug', '=', $landingSlug)->first();

            $slideShowId = $slideSelect->attributes['slider_id'];
            ...
            $slideShowId = $slideSelect->attributes['carousel_id'];
