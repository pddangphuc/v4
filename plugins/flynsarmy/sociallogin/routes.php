...
{
    $success_redirect = Input::get('s', '/favourites');
	$error_redirect = Input::get('f', '/');
    Session::put('flynsarmy_sociallogin_successredirect', $success_redirect);
    Session::put('flynsarmy_sociallogin_errorredirect', $error_redirect);
...
Route::get('flynsarmy/sociallogin/{provider}/callback', ['as' => 'flynsarmy_sociallogin_provider_callback', 'middleware' => ['web'], function($provider_name) {
    $success_redirect = Session::get('flynsarmy_sociallogin_successredirect', '/favourites');
