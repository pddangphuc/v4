                            ...
                            $newresult = $value; 
                             ...
                             if (isset($newresult->property_id)) {
                                ...
                                if($name_query->dates_updated == $eps_date_updated) {
                                    ...
                                    $img_count = Db::table('expedia_expediaimport_images')->where('property_id', $eps_property_id)->where('updated','=','1')->count();
                                    ...
                                    if(strtolower($change_type) == "image") {
                                        $msg = "EPS Images count:".$img_counter."/". "DB Images Count:". $img_count;
                                    }
