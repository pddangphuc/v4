<?php
namespace Expedia\ExpediaUpdate\Classes;
...
class Updater
{
    ...
    public static function doTest() {
       // \Log::useFiles('storage/logs/update.log');
        \Log::info("called from property testing");
    }
    ...
    public static function checkUpdates() {
        ...
        if(!empty($properties)) {
                ...
                if($batch_ctr == 30 && $prop_count >= 0 ) { 
                    ...
                    if (!empty($results)) {
                        ...
                        foreach ($results as $key => $value) { 
                            ...
                            } // End If isset($newresult->property_id
                      ...
                      \Log::error("Can't connect to EPS! No updates done.");
            ...
            \Log::info("Auto update done successfully.");
